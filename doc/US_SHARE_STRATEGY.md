...
**Alpha 策略逐年收益（基准 S&P 500，2000-2026 完整记录）：**

| Year | 策略 | S&P 500 | 超额 | 回撤 | 区间 |
|------|------|---------|------|------|------|
| 2000 | -7.06% | -9.27% | **+2.21%** | -23.21% | 扩展 IS |
| 2001 | 7.53% | -10.53% | **+18.06%** | -12.91% | 扩展 IS |
| 2002 | 11.85% | -23.80% | **+35.65%** | -7.56% | 扩展 IS |
| 2003 | 48.42% | 22.32% | **+26.10%** | -5.54% | 扩展 IS |
| 2004 | 14.84% | 9.33% | **+5.51%** | -9.46% | 扩展 IS |
| 2005 | 19.45% | 3.84% | **+15.61%** | -7.46% | 扩展 IS |
| 2006 | 11.58% | 11.78% | -0.20% | -16.89% | 扩展 IS |
| 2007 | 1.57% | 3.65% | -2.08% | -8.72% | 扩展 IS |
| 2008 | -5.79% | -37.58% | **+31.80%** | -18.10% | 扩展 IS |
| 2009 | 21.87% | 19.67% | +2.20% | -11.92% | 扩展 IS |
| 2010 | 17.50% | 11.00% | **+6.50%** | -11.13% | 扩展 IS |
| 2011 | -3.78% | -1.12% | -2.65% | -14.77% | 扩展 IS |
| 2012 | 5.72% | 11.68% | -5.96% | -12.93% | IS |
| 2013 | 27.27% | 26.39% | +0.88% | -8.84% | IS |
| 2014 | 28.95% | 12.39% | **+16.56%** | -11.17% | IS |
| 2015 | 1.71% | -0.69% | +2.40% | -13.16% | IS |
| 2016 | 2.97% | 11.24% | -8.27% | -9.18% | IS |
| 2017 | 22.57% | 18.42% | **+4.15%** | -11.11% | IS |
| 2018 | -13.68% | -7.01% | -6.67% | -16.87% | IS |
| 2019 | 10.88% | 28.71% | -17.84% | -6.28% | IS |
| 2020 | 70.20% | 15.29% | **+54.90%** | -23.18% | IS |
| 2021 | 4.53% | 28.79% | -24.27% | -19.27% | IS |
| 2022 | -3.29% | -19.95% | **+16.66%** | -11.22% | OOS |
| 2023 | 11.80% | 24.73% | -12.92% | -3.34% | OOS |
| 2024 | 48.73% | 24.01% | **+24.72%** | -14.46% | OOS |
| 2025 | 108.25% | 16.65% | **+91.61%** ⚠️ | -32.10% | OOS |
| 2026 | -2.33% | -5.97% | +3.64% | -7.10% | OOS |

**跨时代 FF5 Alpha 一致性（关键验证）：**
...
**结论：**
- **FF5 Alpha 跨时代一致**：两个完全不同的市场环境（互联网泡沫+金融危机 vs QE 长牛），alpha 水平几乎一样（~6.2%，t~2.2）。这是策略有效性最强的证据
- **β_rmw 问题仅在 2012+ 出现**：2000-2011 β_rmw=-0.05（几乎为零），说明 analyst 大类（含 EPS_REVISION）引入后才产生做空优质资产的偏移
- **熊市表现极强**：2001 +18%、2002 +36%、2008 +32% 超额。S&P 500 跌 37% 时策略仅跌 5.8%
- **2000-2011 超额 +12.33% 远好于 2012-2023 的 +0.89%**：因为包含两次大熊市，L/S 策略空头端真正发挥了保护作用。在 2012-2023 单边牛市中，半仓 L/S 天然跑不赢满仓指数
- **2025 +108% 是 AI 泡沫风格红利**（β_rmw=-1.01），不可持续
