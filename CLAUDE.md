...
10. **严禁重复犯同一个错误** — 被纠正一次，后续所有类似场景必须记住。**[违反 2 次：2026-04-21 多次给出前后矛盾的结论（"不需要删缓存"→"需要删缓存"→"不需要删"；"无法并行"→"可以并行"）]**
...
12. **先说方案再动手** — 多种方案列出让用户选。涉及架构变更必须先讨论。**[违反 2 次：2026-04-21 polars 全切未确认就开始改；2026-04-22 串行评分加速未设计方案就开始改代码]**
