...
| Step 4 | 截面风控（行业软约束 15%），替代时序风控 | ✅ DD改善 -29.8%→-24.7%，alpha 从 6.73%→2.56% |
| Step 4.5 | 样本外验证（2024-2026） | ✅ alpha 消失（-1.61%，t=-0.23），策略为 β=0.65 被动跟踪 |
| Step 5 | 盈利预期修正因子 + LLM 舆情增强 | 📋 当前因子行业内选股力不足，需新数据源 |
