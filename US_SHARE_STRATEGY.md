...
|------|---------|-------------|
| 总收益 | **+251.8%** | +226.3% |
| 最终净值 | **$351.7 万** | $326.3 万 |
| 年化收益 | **12.15%** | 11.38% |
| 超额年化 | **+0.77%** | — |
| 夏普比率 | **0.58** | — |
| 最大回撤 | -22.7% (2016-02-11) | — |
| 年化波动率 | 14.1% | — |
| 胜率 | 54.8% | — |
| FF5 Alpha (年化) | **+5.42%** | — |
| FF5 Alpha t-stat | **1.69** (接近显著) | — |
| β_Mkt | 0.46 | — |
| 年化换手率 | 426% | — |

> **幸存者偏差修正：** 股票池包含 S&P 500 历史成分股（2015 年以来 227 只被移除的公司），
> 从 Wikipedia 变更记录提取，yfinance 下载行情 + SEC EDGAR 下载财报 + yfinance 补全 sector。
> 修正前 t-stat=2.21，修正后 1.69 — 约 2-3%/年的"alpha"来自幸存者偏差。
