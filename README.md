...
> **策略特征：** 熊市保护强（2015 +11.8%, 2018 +22.5%, 2022 +27.7%），牛市跟不上（2019 -28.4%, 2021 -21.8%）— 半仓 L/S 的天然代价。IS FF5 Alpha 6.66%（t=2.26，5% 显著）。2025 年 +108% 是 AI 泡沫风格红利（β_rmw=-1.01），不可持续。Alpha v4 将研究二次规划优化器施加 β_rmw 约束。
