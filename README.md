...
美股管道（三策略：Alpha 多空对冲 + Beta Regime 控制 + Baseline VQM 验证）:
  ...
  → data/us_cleaner.py → us_factors/*.py (25因子×7大类) → us_factors/processor.py
...
## 美股因子体系（25 因子 × 7 大类，`services/us_factors/`）
...
| analyst | 1.0 | US_ANALYST_RATING, US_ANALYST_COVERAGE, EARNINGS_SURPRISE, EPS_REVISION |
