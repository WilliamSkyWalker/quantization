...
| 指标 | v3 IS (2012-2023) | v3 OOS (2024-2026) | v2 IS (2015-2025) |
|------|-------------------|-------------------|-------------------|
| 年化收益 | 14.39% | **20.95%** | 17.2% |
| 最大回撤 | -25.6% | **-18.8%** | -29.8% |
| Sharpe | 0.74 | **0.87** | 0.72 |
| FF5 Alpha | +6.68% (t=2.02) | +15.06% (t=1.86) | +6.73% (t=2.20) |
| 市场 Beta | 0.48 | 0.46 | 0.82 |
| 下行/上行捕获 | 0.46 / 0.77 | 0.44 / 0.97 | — |

> Alpha v3：31 因子 + trailing 36M 滚动 IC 动态方向。IS alpha=6.68%(t=2.02)，OOS alpha=15.06%(t=1.86)。
>
> **⚠️ 诚实评价：** IS alpha ~6.7% 勉强显著，与 v2 持平。OOS 受 AI 牛市风格红利放大（β_rmw=-0.42），t=1.86 未达 5% 显著性。策略真正优势是下行捕获稳定 0.44~0.46（跌一半）。Alpha v4 将研究二次规划优化器施加 β_rmw 约束。
...
| 美股 Alpha v3 | 31 因子 + 滚动 IC → IS α=6.68%(t=2.02)，OOS α=15.06%(t=1.86) | ✅ |
